...
const BASE_URL ='http://api.exchangeratesapi.io/v1/latest?access_key=Y9WG0c7wiUrZxgYaiYMBRuN1X0Y5mXrS'
const CONVERT_URL ='http://api.exchangeratesapi.io/v1/convert?access_key=Y9WG0c7wiUrZxgYaiYMBRuN1X0Y5mXrS'
const Currency = () => {
